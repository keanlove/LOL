...
@interface AnchorVideoController () <UITableViewDelegate, UITableViewDataSource>


@end

@implementation AnchorVideoController {
...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.navigationItem.title = self.model.N;
...
- (void)loadMoreData {
    ...
    _tableView.header = [MJRefreshNormalHeader headerWithRefreshingBlock:^{
        ...
        dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
            ...
            [[NetworkSingleton sharedManager] GET:[NSString stringWithFormat:@"%@%@%@%@%@",AnchorVideoURL_1, self.model.I, AnchorVideoURL_2, time, AnchorVideoURL_3] parameters:nil success:^(id responseObject) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    AnchorVideoViewCell *cell = [AnchorVideoViewCell loadCellWithTableView:tableView];
