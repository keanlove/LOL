...
@interface CompetitionController ()<UITableViewDelegate, UITableViewDataSource>

@end

@implementation CompetitionController {
...
- (void)loadMoreData {
    ...
    _tableView.header = [MJRefreshNormalHeader headerWithRefreshingBlock:^{
        ...
        dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
            ...
            [[NetworkSingleton sharedManager] GET:[NSString stringWithFormat:@"%@%d%@%@%@",AnchorVideoURL_1, 211, AnchorVideoURL_2, time, AnchorVideoURL_3] parameters:nil success:^(id responseObject) {
