...
@interface GatherController ()<UITableViewDelegate, UITableViewDataSource>

@end

@implementation GatherController {
...
- (void)loadMoreData {
    ...
    _tableView.header = [MJRefreshNormalHeader headerWithRefreshingBlock:^{
        ...
        dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
            ...
            [[NetworkSingleton sharedManager] GET:[NSString stringWithFormat:@"%@%d%@%@%@",AnchorVideoURL_1, 67, AnchorVideoURL_2, time, AnchorVideoURL_3] parameters:nil success:^(id responseObject) {
